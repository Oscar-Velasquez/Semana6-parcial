...
import com.example.multifuncion.PagerController.PagerController;
import com.google.android.material.tabs.TabItem;
import com.google.android.material.tabs.TabLayout;

public class controles_basicos extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem opcion_menu) {
        ...
        if (id == R.id.aboutUs) {
            Toast.makeText(this, "Opcion de Sobre nosotros", Toast.LENGTH_LONG).show();
            return true;
        }
        if (id == R.id.imagenes) {
